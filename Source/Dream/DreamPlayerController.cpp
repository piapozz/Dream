...
ADreamPlayerController::ADreamPlayerController()
{
	...
	PlayerCameraManagerClass = ADreamCameraManager::StaticClass();
}
...
void ADreamPlayerController::BeginPlay()
{
	...
	if (IsLocalPlayerController() && ShouldUseTouchControls())
	{
		...
		if (MobileControlsWidget)
		{
			...
			UE_LOG(LogDream, Error, TEXT("Could not spawn mobile controls widget."));
...
bool ADreamPlayerController::ShouldUseTouchControls() const
{
